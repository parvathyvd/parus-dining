        ...
        <div id="tab-container" class="tab-container">
          ...
          <div id="tabs1">
              <ul class="list-unstyled d-flex mx-auto">
                <li><img src="img/1.jpg" alt="food" class="img-fluid"/></li>
                <li><img src="img/2.jpg" alt="food" class="img-fluid"/></li>
                <li><img src="img/3.jpg" alt="food" class="img-fluid"/></li>
                <li><img src="img/4.jpg" alt="food" class="img-fluid"/></li>
            </ul>
          </div>
          <div id="tabs2">
            <ul class="list-unstyled d-flex mx-auto">
              ...
              <li><img src="img/6.jpg" alt="food" class="img-fluid"/></li>
              <li><img src="img/7.jpg" alt="food" class="img-fluid"/></li>
          </ul>
          </div>
          <div id="tabs3">
            <ul class="list-unstyled d-flex mx-auto">
